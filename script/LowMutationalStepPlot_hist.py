...
df_data['Negative Match Distance Change'] = -df_data['Match Distance Change']
...
def draw(*args, **kwargs):
    ...
    x, binedges = np.histogram(
        df_data["Negative Match Distance Change"],
        bins=bins,
    )
...
g.fig.text(0.2, 0.1, s='Negative Match Distance Change', fontdict={'fontsize':10})
