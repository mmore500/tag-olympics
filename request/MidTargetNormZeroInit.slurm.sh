...
mutation_rates = [0.125, 0.1875, 0.25, 0.375, 0.5, 0.75, 1.0, 1.5, 2.0, 3.0, 4.0, 6.0, 8.0, 12.0, 16.0, ]
target_degrees = [ '1', '2', ]
...
OUTPUT_DIR="/mnt/scratch/mmore500/tag-olympics-midtarget-norm-zeroinit/run=${SLURM_ARRAY_TASK_ID}"
...
for REP in {0..9}; do
  ...
  ./mid-tag-olympics MBM                                                       \
    ...
    -MFM_GENS 515 -MFM_ZEROINIT 1 -MO_LENGTH 32                                \
    -MO_MUT_NORMAL 1 -MO_MUT_NORMAL_SD $MUTATION_RATE                          \
